#!/usr/bin/env python3
# Synced copy. Canonical source: ~/Development/sweepstake/scoring.py
# Re-copy after any change there. If you change scoring constants here,
# re-run sim.py in the sweepstake repo to re-verify the calibration.
"""
